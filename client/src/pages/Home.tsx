    ...
    <Layout>
      ...
      <section className="relative min-h-[80vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source
              src="/images/v24044gl0000d45815fog65g344e2rb0.mp4"
              type="video/mp4"
            />
          </video>
        ...
        <div className="container relative z-10 text-center md:text-left pt-24 pb-16">
          ...
          >
            <motion.div
              variants={fadeIn}
              className="inline-block mb-4 px-4 py-1.5 rounded-full bg-secondary/20 border border-secondary/50 backdrop-blur-sm"
            >
            ...
            >
              More than a martial art. We are a movement-driven community in
              Croydon rooted in Afro-Brazilian culture, created to support body,
              mind, and collective strength.
            </motion.p>
            ...
            >
              <Link href="/join-now">
                <Button
                  size="lg"
                  className="bg-secondary text-secondary-foreground hover:bg-secondary/90 font-bold text-lg px-8 h-14 rounded-full w-full sm:w-auto"
                >
                  Join Our Community
                </Button>
              </Link>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Capoeira is a vibrant blend of movement, music, and culture,
                born from resilience and the enduring pursuit of freedom. It's a
                game, a dance, and a fight all at once, where creativity flows,
                strength is tested, and rhythm drives expression.
              </motion.p>
              <motion.p
                variants={fadeIn}
                className="text-lg text-muted-foreground mb-8 leading-relaxed"
              >
                At Capoeira Club Croydon, we use this powerful tool for physical
                fitness, coordination, confidence, and cultural education.
              </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 order-2 lg:order-1">
              ...
              >
                <motion.div
                  variants={fadeIn}
                  className="inline-block mb-4 px-4 py-1 rounded-full border border-secondary text-secondary text-xs font-bold uppercase tracking-wider"
                >
                  Our Leadership
                </motion.div>
                <motion.h2
                ...
                >
                  Capoeira Club Croydon is proudly led by{" "}
                  <span className="text-secondary font-bold">
                    Professora Areia
                  </span>
                  , shaping a space where leadership, care, discipline, and
                  empowerment coexist.
                </motion.p>
                ...
                >
                  <div className="border-l-2 border-secondary pl-6">
                    ...
                    <p className="text-primary-foreground/70">
                      This perspective influences how classes are taught, how
                      people are welcomed, and how the community grows.
                    </p>
                  </div>
                  <div className="border-l-2 border-secondary pl-6">
                    <p className="text-lg font-bold text-white mb-2">
                    ...
                    <p className="text-primary-foreground/70">
                      A special dedication to helping women discover their
                      strength and leadership within this art form.
                    </p>
                  </div>
                </motion.div>
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              We use Capoeira as a powerful tool for holistic growth, connecting
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-secondary font-bold uppercase tracking-widest mb-2 text-sm">
                Our Offerings
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="overflow-hidden border-none shadow-lg group">
              ...
              <CardContent className="p-8">
                ...
                <a
                  href="https://buy.stripe.com/dRm9AUa7X3Dg0H51VEawo07"
                  target="_blank"
            ...
            <Card className="overflow-hidden border-none shadow-lg group">
              ...
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Specially designed for children, combining fun, movement, and
                  learning. Kids develop coordination, confidence, and cultural
                  awareness.
                </p>
            ...
            <Card className="overflow-hidden border-none shadow-lg group">
              ...
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Experience Capoeira beyond regular classes through cultural
                  celebrations, Black History Month events, graduations, and
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-10 md:p-16 flex flex-col justify-center">
                ...
                <p className="text-xl text-primary-foreground/80 mb-8">
                  Join us for a class and experience the energy, community, and
                  culture of Capoeira Club Croydon.
                </p>
