    ...
    <Layout>
      ...
      <section className="bg-primary text-primary-foreground py-20 md:py-32 relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          >
            Join our supportive community where beginners and experienced
            practitioners train together.
          </motion.p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                All classes are held at our Croydon location.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground pt-2">
                    Specially designed for children, offering an exciting and
                    educational experience. Sessions are all about fun,
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground pt-2">
                    A wonderful opportunity for parents and children to bond,
                    move, and learn together. Build strength and connection as a
                    family unit.
                  </p>
                  <a
                    href="https://all.lewisham.gov.uk/enrol/index.php?id=26205"
                    target="_blank"
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground pt-2">
                    A tailored, supportive environment for children with Special
                    Educational Needs and Disabilities. Focus on sensory
                    engagement and motor skills.
                  </p>
                  <SENDClassRegistrationDialog className="w-full mt-4 bg-primary text-primary-foreground hover:bg-primary/90" />
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Every class is a journey through the different elements of
              Capoeira.
            </p>
          </div>
